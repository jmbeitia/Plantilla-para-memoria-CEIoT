...
\usepackage{float}
\usepackage{placeins}    % Provee \FloatBarrier para acotar el desplazamiento de flotantes
\usepackage{array}       % Provee >{...} para definir tipos de columna propios

% Columna de ancho fijo con el texto alineado a la izquierda: evita los espacios
% estirados entre palabras que produce la justificación en columnas angostas.
\newcolumntype{L}[1]{>{\raggedright\arraybackslash}p{#1}}

% Los títulos de sección no se cortan con guión al final de línea: TeX prefiere
% quebrar en el espacio antes que partir la palabra (comentario del revisor).
\usepackage{sectsty}
...
\begin{acknowledgements}
    ...
    Agradezco también a mi director, Christian Marcelo Yanez Flores, por su acompañamiento académico y sus aportes técnicos a lo largo de todo el proceso, y a mi codirector, Matías Martini, cuya experiencia en desarrollo de software e inteligencia artificial aplicada enriqueció las decisiones de diseño e implementación.

    Mi reconocimiento se extiende a mis compañeros y colegas, cuya colaboración fue esencial para superar los desafíos surgidos durante la implementación.

    Por último, agradezco a mis amigos y a mi familia, cuya paciencia y aliento incondicional fueron mi sostén durante este proceso, permitiéndome perseguir mis proyectos y crecer profesionalmente.
