...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        \vspace*{5.5cm} % Ajustar según la posición vertical deseada

        % Título
        {\fontfamily{phv}\bfseries\fontsize{33pt}{40pt}\selectfont
            Automatización inteligente del flujo de pedidos para un mercado de frutas y verduras} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
            Esp. Ing. Joaquín Manuel Beitia} \\[1cm]
        ...
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
            \textbf{Director:} Mg. Ing. Christian Marcelo Yanez Flores (INTI / FIUBA)
        } \\[0.3cm]

        % Codirector
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
            \textbf{Codirector:} Matías Martini (Xepelin)
        } \\[1cm]
        ...
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
            Mg. Ing. Pedro Rosito (FIUBA)} \\[2cm]

        % Fecha y lugar
        {\fontfamily{phv}\itshape\fontsize{10pt}{12pt}\selectfont
            Ciudad de Rosario, octubre de 2026} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
