...
La tercera es la plataforma de atención vinculada al canal de mensajería, que conserva cada mensaje entrante con su marca temporal, su contacto de origen y el tipo de contenido de sus adjuntos. Esa fuente aporta la única información disponible sobre el formato del mensaje original, dimensión que las dos anteriores no permiten discriminar, y sostiene la auditoría de la sección \ref{subsec:ensayo_formatos}. Su vinculación con los pedidos no es directa, ya que ambos sistemas no comparten identificadores, y debió reconstruirse por coincidencia del número de contacto y proximidad temporal según el procedimiento que allí se detalla.
...
La forma en que esas denominaciones quedaron registradas resulta significativa. La variedad Ellendale aparece bajo nueve escrituras distintas y la variedad Bosc bajo quince, con deformaciones progresivas del tipo \emph{Boschi}, \emph{Boscoli} o \emph{Boschaitis}, que se prolongan hasta el grupo de denominaciones carentes de correspondencia interpretable, integrado por 80 casos repartidos en 68 escrituras distintas. La morfología de esas deformaciones es la propia de una transcripción, y no la de un error de tipeo, lo que sugiere que el conjunto proviene de la lectura de listas con terminología ausente del catálogo, situación en la que el agente carece de referencia para normalizar aquello que interpreta.

Esa lectura constituye una hipótesis sobre el origen del error y no un resultado medido. La auditoría por formato de entrada de la sección \ref{subsec:ensayo_formatos} fue diseñada para contrastarla y no la confirma: la tasa de asociación no presenta diferencias apreciables entre los formatos de entrada, de modo que el error residual no se concentra en la modalidad de imagen. Lo que sí distingue a esa modalidad es el tamaño del pedido, según se analiza en dicha sección.
...
El flujo de sincronización de contactos, que actualiza de forma programada los nombres de los clientes a partir de la agenda del comercio, presenta una duración media del orden de la hora, con trece ejecuciones en catorce días. Ese valor no refleja un costo de cómputo sino las esperas deliberadas que el flujo intercala entre lotes para respetar los límites de tasa de las interfaces que consume. Al operar de forma desacoplada del flujo de pedidos, no incide sobre la latencia percibida por el comercio.
...
Corresponde precisar qué unidad mide esta distribución. Durante la ventana analizada, 1786 ejecuciones completaron la interpretación frente a 789 pedidos persistidos, lo que arroja una relación de 2,26 ejecuciones por pedido. El origen de esa relación se verificó reconstruyendo, sobre el registro de la plataforma de atención, las agrupaciones de mensajes que el mecanismo de espera por inactividad habría formado en esa misma ventana. Con el criterio de corte de sesenta segundos aplicado a los 3386 mensajes entrantes recibidos de contactos individuales, la reconstrucción arroja 1893 agrupaciones; con un corte de noventa segundos, que absorbe la latencia de ingreso de cada mensaje, arroja 1801. Ese valor difiere en menos del uno por ciento de las 1786 ejecuciones que efectivamente interpretaron.
...
Los dos sistemas no comparten identificadores, de modo que la correspondencia entre un mensaje y el pedido que produjo debió reconstruirse. El procedimiento aprovecha el mecanismo de agrupación por inactividad descripto en la sección \ref{subsec:composicion_latencia}: dado que el flujo persiste el pedido una vez transcurrida la espera sin nuevos mensajes, todo pedido debe estar precedido por un mensaje del mismo contacto a una distancia próxima a esa espera. Se emparejó entonces cada pedido con el último mensaje entrante recibido del mismo número de contacto con anterioridad a su registro.

La distribución de esas distancias confirma la validez del emparejamiento. La mediana es de 72 segundos, con un primer cuartil de 68 y un tercer cuartil de 85, valores que reproducen la espera de sesenta segundos más el tiempo de procesamiento. Se consideraron atribuibles los pedidos cuyo mensaje precedente se ubica a no más de 120 segundos, criterio que alcanza a 3038 de los 3871 pedidos de la ventana, es decir el 78,48 por ciento. Para cada uno de ellos se reconstruyó además la agrupación completa, con un encadenamiento hacia atrás de los mensajes separados por menos de noventa segundos, y se asignó al pedido el formato de los adjuntos presentes en esa agrupación.

La cobertura del emparejamiento se mantiene estable a lo largo de todo el período, con una mediana diaria del 79 por ciento y un mínimo del 61 por ciento, sin días de cobertura anómala. Esa uniformidad permite descartar que el subconjunto atribuido corresponda a un tramo particular de la operación y sostiene su uso como muestra del conjunto.

\subsubsection*{Composición del tráfico y resultados por formato}

Durante la ventana de 75 días se recibieron 16619 mensajes entrantes de contactos individuales. De ese total, el 77,39 por ciento fue texto, el 12,41 por ciento audio, el 8,29 por ciento imagen, el 1,78 por ciento documento y el 0,14 por ciento video. Las cuatro modalidades previstas por el requerimiento se presentan, por lo tanto, en la operación real y con volumen suficiente para ser comparadas, con la salvedad del video, cuya presencia es marginal.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{l c c c c c}
        ...
        \midrule
        Texto            & 2013             & 66,26       & 12060          & 99,17                       & 5,99                  \\
        ...
        \midrule
        Total            & 3038             & 100,00      & 20485          & 99,19                       & 6,74                  \\
        \bottomrule
    \end{tabular}
\end{table}
...
La primera es que el indicador empleado es la tasa de asociación de los ítems con el catálogo, no la exactitud de la interpretación. Un ítem asociado a un producto puede haber sido interpretado con una cantidad o una unidad incorrectas, y ese error no queda registrado en ninguna de las fuentes disponibles. La verificación de los tres atributos de manera independiente exigiría contrastar cada pedido contra el contenido del mensaje original, tarea que sobre el volumen analizado solo sería viable por muestreo manual.

La segunda es que el tiempo extremo a extremo no puede desagregarse por formato. El instante de llegada del mensaje se conserva en la plataforma de atención y el de persistencia del pedido en la base relacional, pero el registro de ejecuciones no discrimina la modalidad procesada, de modo que no es posible aislar el costo de la transcripción de audio o de la lectura de imagen dentro de la latencia total.

La tercera es que el 21,52 por ciento de los pedidos de la ventana no pudo atribuirse a ningún mensaje próximo. Ese conjunto presenta pedidos de mayor tamaño, con 10,78 ítems por pedido, y una tasa de asociación inferior, del 96,75 por ciento, de modo que su exclusión eleva el valor global de la muestra auditada por encima del 98,45 por ciento del conjunto completo. La comparación entre formatos no resulta afectada, ya que el sesgo opera sobre todas las modalidades por igual, pero los valores absolutos de la tabla \ref{tab:formatos} no deben leerse como la tasa de asociación del sistema, que es la reportada en la sección \ref{subsec:items_no_reconocidos}.

\subsection{Ensayo de interfaz}
\label{subsec:ensayo_interfaz}

% [PENDIENTE: completar esta subsección con los resultados del checklist de
% navegadores y responsive. Estructura sugerida abajo; reemplazar los valores
% entre corchetes por las observaciones reales.]

El acceso al panel sin instalación adicional y su adaptación a distintos tamaños de pantalla se verificaron mediante un recorrido funcional en los tres navegadores de mayor uso y en dos anchos de pantalla representativos de un dispositivo móvil y una tableta.

Se recorrieron las vistas de tablero, pedidos, detalle de pedido, productos, clientes y estadísticas en Google Chrome, Mozilla Firefox y Microsoft Edge, con registro de la presencia de errores en la consola del navegador. [Resultado: N de N navegadores sin errores de consola / detalle de las excepciones encontradas].

La adaptación a distintos tamaños de pantalla se evaluó con una reducción del ancho de la ventana a 375 y 768 píxeles, valores representativos de un teléfono y una tableta en orientación vertical. [Resultado: comportamiento del menú de navegación, legibilidad de las tablas y usabilidad de los controles en cada ancho].

    [Conclusión: síntesis de si el panel resultó utilizable sin instalación adicional y en los anchos de pantalla evaluados, con las salvedades que correspondan].
...
\begin{table}[htbp]
    ...
    \begin{tabular}{c p{6.2cm} p{4.6cm}}
        ...
        \midrule
        1.2           & Auditoría por formato de entrada                                    & Cuatro formatos en operación; tasa de asociación entre 99,17 y 99,32 por ciento sin diferencia entre texto, audio e imagen \\
        ...
        1.4           & Persistencia de pedidos, clientes y productos en PostgreSQL         & Verificado; modelo de datos de la sección \ref{subsec:modelo_datos}                                                        \\
        1.5           & Uso de Redis para sesiones y clientes activos                       & Verificado; mecanismo de agrupación de la sección \ref{subsec:agrupacion}                                                  \\
        ...
        1.9           & Panel con pedidos en tiempo real, historial y métricas              & Verificado; uso diario continuo durante el período analizado                                                               \\
        1.10          & Configuración de productos, precios y catálogo desde el panel       & Verificado; sección \ref{subsec:panel}                                                                                     \\
        \midrule
        4.1           & Acceso al panel sin instalación adicional                           & Sección \ref{subsec:ensayo_interfaz}                                                                                       \\
        4.2           & Interfaz clara con alertas de pedidos nuevos                        & Verificado; tablero con bloques de alerta, sección \ref{subsec:panel}                                                      \\
        4.3           & Adaptación a distintos tamaños de pantalla                          & Sección \ref{subsec:ensayo_interfaz}                                                                                       \\
        \midrule
        5.1           & Compatibilidad con la API oficial de WhatsApp Business              & Diseño declarado compatible; migración no ejecutada                                                                        \\
        5.2           & Soporte para múltiples dispositivos o cuentas                       & No evaluado con la evidencia disponible                                                                                    \\
        5.3           & Exportabilidad de los flujos de n8n                                 & Verificado; los flujos se versionan como archivos JSON                                                                     \\
        \bottomrule
    \end{tabular}
\end{table}
...
La primera es la dependencia del sistema respecto del estado del catálogo. La cobertura incompleta y la baja de productos vigentes explican 364 de los 458 ítems no asociados, es decir el 79,48 por ciento. Ese conjunto reúne los productos incorporados con posterioridad, los de almacén y los frescos ausentes, los dados de baja y las variedades comerciales y códigos de calibre, que se retoman en la limitación siguiente por constituir un caso de naturaleza propia dentro de esa misma causa. El sistema carece de un mecanismo que anticipe esa condición, de modo que la incorporación de productos ocurre siempre con posterioridad al primer pedido que los solicita.

La segunda es la cobertura del catálogo frente a la terminología del comercio mayorista. Las variedades y los códigos de calibre que aparecen en las listas de proveedor no tienen correspondencia en el catálogo, que registra los productos con su nombre genérico, y concentran 112 casos. Sumados a las 80 denominaciones sin correspondencia interpretable, que no responden a la cobertura del catálogo sino a la lectura del mensaje de origen, alcanzan el 41,92 por ciento de los ítems no asociados. La distinción es relevante porque ambos grupos exigen medidas distintas: los primeros se resuelven con una ampliación del catálogo, mientras que los segundos dependen de la calidad del mensaje recibido.
