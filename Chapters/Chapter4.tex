...
\begin{table}[H]
    ...
    \label{tab:ventanas}
    \begin{tabular}{L{5.2cm} L{3.3cm} c L{3.2cm}}
        \toprule
...
\begin{table}[H]
    ...
    \begin{tabular}{l c c c c c}
        ...
        \addlinespace
        \textbf{Total}   & 3038             & 100,00      & 20\,485        & 99,19                       & 6,74                  \\
        \bottomrule
    \end{tabular}
\end{table}
...
La tabla \ref{tab:verificacion_funcional} reúne los requerimientos verificados por comprobación funcional cuyo resultado aporta algo más que el cumplimiento. Los restantes se omiten por no arrojar un resultado distinto de este: la persistencia y el uso de Redis de las secciones \ref{subsec:modelo_datos} y \ref{subsec:agrupacion} (1.4 y 1.5), el panel con sus alertas y su configuración del catálogo de la sección \ref{subsec:panel} (1.9, 1.10 y 4.2), el acceso sin instalación de la sección \ref{subsec:ensayo_interfaz} (4.1) y el versionado de los flujos (5.3).
