...
\begin{table}[H]
	...
	\begin{tabular}{L{3.2cm} L{2.6cm} L{2.6cm} L{2.6cm}}
		\toprule
		\textbf{Criterio}           & \textbf{Nube pura} & \textbf{Automatización de mensajería} & \textbf{Enfoque híbrido (este trabajo)} \\
		\midrule
...
\begin{itemize}
	\item Capturar de forma automática los pedidos entrantes por el canal de mensajería, en sus distintos formatos: texto, voz, imagen y documento.
	\item Interpretar el contenido de cada pedido mediante modelos de inteligencia artificial, para identificar productos, cantidades y unidades, y normalizar denominaciones equivalentes de un mismo producto.
	...
	\item Imprimir automáticamente el pedido en una impresora térmica conectada a un servidor local, para garantizar la actuación en el borde con baja latencia.
