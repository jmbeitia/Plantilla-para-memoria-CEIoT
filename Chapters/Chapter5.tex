...
La desviación deliberada de mayor consecuencia fue adelantar la puesta en producción respecto del final del desarrollo. El sistema recibió su primer pedido el 4 de junio de 2026, cuando el panel todavía se encontraba en construcción y el comercio aún no contaba con la impresora térmica: durante las primeras cuatro semanas los pedidos interpretados se volcaron a un archivo de texto de consulta manual, y la impresión automática se habilitó recién el 29 de junio, una vez verificada la calidad de la interpretación. La decisión redujo el riesgo de la puesta en marcha, ya que ningún fallo de interpretación pudo traducirse en un ticket erróneo, y aportó cuatro semanas de datos reales que orientaron la ampliación del catálogo. Su costo fue una mayor carga operativa para el personal durante ese lapso.
...
El riesgo de sobrecostos en el consumo de los servicios de inteligencia artificial no pudo evaluarse con la evidencia disponible en el sistema, ya que el gasto se registra en el panel de facturación del proveedor y no en ninguna de las fuentes empleadas en este trabajo.
% [PENDIENTE: incorporar el costo real del período 04/06 al 17/08 de 2026 desde el
% panel de facturación de OpenAI, y contrastarlo contra el presupuesto previsto en
% la planificación para cerrar este riesgo. Dato no obtenible desde el servidor.]

Como observación transversal, el dimensionamiento de la infraestructura resultó holgado: el servidor virtual sostuvo la totalidad de los servicios con una carga de cómputo y de disco muy por debajo de su capacidad, tras más de siete meses de servicio ininterrumpido.
