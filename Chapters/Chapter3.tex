...
En el presente capítulo se describen el diseño y la implementación del sistema. Se presenta la arquitectura general y la distribución del cómputo entre el comercio y la nube. Luego se detalla cada capa: la captura de los pedidos, la conectividad entre los componentes, el procesamiento y la persistencia, la interfaz de usuario y las medidas de seguridad. En cada sección se exponen los principales desafíos de diseño, los criterios adoptados y la justificación de las decisiones tomadas.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.45\textwidth]{Figures/ticket_impreso.png}
